...
<html>
  <head>
   ...
   <link rel="stylesheet" href="<?php echo base_url();?>assets/admin/Ionicons/css/ionicons.min.css">
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/admin/js/iCheck/square/blue.css">
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?php echo base_url(); ?>assets/index2.html"><b>Login</b>Administrator</a>
      </div>

      <!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">
         Masuk Untuk Kelola Data!
        </p>
